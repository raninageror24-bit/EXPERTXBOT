...
def get_batch_otp_price(num):
    """যেই নাম্বার থেকে OTP এসেছে সেটা কোন ব্যাচের (Upload Number-এ সেট করা) সেটা খুঁজে সেই ব্যাচের নির্দিষ্ট OTP price রিটার্ন করে, না পেলে global default।"""
...
➖➖➖➖➖➖➖➖"""
        ...
        # 🌟 ইউজার পেমেন্ট স্ক্রিনশট পাঠাচ্ছে
            ...
            for num in fetched_nums:
                ...
                btn_text = f"{display_num} {status_icon}".strip() if emoji_id else f"{flag_char} {display_num} {status_icon}".strip()
    ...
    if text.startswith("/start"):
        ...
        if not all_services:
            ...
            if work_services:
                kb.append([{"text": "── 🛠 OTP WORK ──", "icon_custom_emoji_id": "5420323438508155202", "callback_data": "ignore", "style": "secondary"}])
